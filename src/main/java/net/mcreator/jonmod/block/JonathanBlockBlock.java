...
public class JonathanBlockBlock extends JonmodModElements.ModElement {
	@ObjectHolder("jonmod:jonathan_block")
	public static final Block block = null;
	public JonathanBlockBlock(JonmodModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("jonathan_block");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A776,561 Jons"));
			list.add(new StringTextComponent("\u00A75Level 4"));
		}
