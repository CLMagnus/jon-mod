...
public class PrettyAlrightJonBlockBlock extends JonmodModElements.ModElement {
	@ObjectHolder("jonmod:pretty_alright_jon_block")
	public static final Block block = null;
	public PrettyAlrightJonBlockBlock(JonmodModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("pretty_alright_jon_block");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A774,782,969 Jons"));
			list.add(new StringTextComponent("\u00A73\u00A7lLevel 7"));
		}
