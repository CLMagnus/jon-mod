...
public class AlmostThereJonBlockBlock extends JonmodModElements.ModElement {
	@ObjectHolder("jonmod:almost_there_jon_block")
	public static final Block block = null;
	public AlmostThereJonBlockBlock(JonmodModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("almost_there_jon_block");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77387,420,489 Jons"));
			list.add(new StringTextComponent("\u00A75\u00A7lLevel 9"));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DoingWellJonBlockBlock.block, (int) (8)));
		}
	}
}
