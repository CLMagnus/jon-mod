...
public class GreaterJonBlockBlock extends JonmodModElements.ModElement {
	@ObjectHolder("jonmod:greater_jon_block")
	public static final Block block = null;
	public GreaterJonBlockBlock(JonmodModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("greater_jon_block");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77729 Jons"));
			list.add(new StringTextComponent("\u00A74Level 3"));
		}
