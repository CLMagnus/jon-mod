...
public class JonBlockBlock extends JonmodModElements.ModElement {
	@ObjectHolder("jonmod:jon_block")
	public static final Block block = null;
	public JonBlockBlock(JonmodModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A779 Jons"));
			list.add(new StringTextComponent("\u00A72Level 1"));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(JonItem.block, (int) (8)));
		}
	}
}
