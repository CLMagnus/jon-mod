...
public class EchJonBlockBlock extends JonmodModElements.ModElement {
	@ObjectHolder("jonmod:ech_jon_block")
	public static final Block block = null;
	public EchJonBlockBlock(JonmodModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77531,441 Jons"));
			list.add(new StringTextComponent("\u00A72\u00A7lLevel 6"));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(JonathanTronathanBlockBlock.block, (int) (8)));
		}
	}
}
