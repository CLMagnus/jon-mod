...
public class JonOreBlock extends JonmodModElements.ModElement {
	@ObjectHolder("jonmod:jon_ore")
	public static final Block block = null;
	public JonOreBlock(JonmodModElements instance) {
		super(instance, 11);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(JonItem.block, (int) (3)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("jonmod:jon_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("jon_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("jonmod:jon_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
