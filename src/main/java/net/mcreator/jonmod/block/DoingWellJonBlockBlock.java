...
public class DoingWellJonBlockBlock extends JonmodModElements.ModElement {
	@ObjectHolder("jonmod:doing_well_jon_block")
	public static final Block block = null;
	public DoingWellJonBlockBlock(JonmodModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("doing_well_jon_block");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7743,046,721 Jons"));
			list.add(new StringTextComponent("\u00A74\u00A7lLevel 8"));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PrettyAlrightJonBlockBlock.block, (int) (8)));
		}
	}
}
