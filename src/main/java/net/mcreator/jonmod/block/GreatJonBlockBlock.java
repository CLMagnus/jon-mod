...
public class GreatJonBlockBlock extends JonmodModElements.ModElement {
	@ObjectHolder("jonmod:great_jon_block")
	public static final Block block = null;
	public GreatJonBlockBlock(JonmodModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("great_jon_block");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7781 Jons"));
			list.add(new StringTextComponent("\u00A73Level 2"));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(JonBlockBlock.block, (int) (8)));
		}
	}
}
