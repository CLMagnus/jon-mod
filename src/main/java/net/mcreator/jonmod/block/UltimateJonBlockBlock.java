...
public class UltimateJonBlockBlock extends JonmodModElements.ModElement {
	@ObjectHolder("jonmod:ultimate_jon_block")
	public static final Block block = null;
	public UltimateJonBlockBlock(JonmodModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("ultimate_jon_block");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A773,486,784,401 Jons"));
			list.add(new StringTextComponent("\u00A73\u00A7lLevel 10"));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AlmostThereJonBlockBlock.block, (int) (8)));
		}
	}
}
