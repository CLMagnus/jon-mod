...
public class JonNuggetItem extends JonmodModElements.ModElement {
	@ObjectHolder("jonmod:jon_nugget")
	public static final Item block = null;
	public JonNuggetItem(JonmodModElements instance) {
		super(instance, 4);
	}
