...
public class JonSubnuggetItem extends JonmodModElements.ModElement {
	@ObjectHolder("jonmod:jon_subnugget")
	public static final Item block = null;
	public JonSubnuggetItem(JonmodModElements instance) {
		super(instance, 5);
	}
